            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data[0]) {
                        ...
                        alert('Только зарегестрированные пользователи могут бронировать Мотодома. Пожалуйста зарегестрируйтесь или авторизируйтесь, если вы уже имеете логин и пароль.');
                    }
